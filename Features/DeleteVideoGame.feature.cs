...
namespace video_game_database_test.Features
{
    ...
    public partial class DeleteVideoGameFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "DeleteVideoGame", "As a user, I want to be able to send a DELETE request to the \'/api/v2/videogame/{" +
