...
I want to be able to pass an id number in a GET request using a specified end point,
...
Scenario Outline: Check various valid IDs return their respective games
	Given I am creating a GET request for the specified endpoint with an ID of <ID> for the "V2" API version
